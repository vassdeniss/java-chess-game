...
public class TestCastling {
    ...
    public void testWhiteKingSideCastle() {
        ...
        final MakeTransition t7 = t6.getToBoard().currentPlayer().makeMove(wm1);
    ...
    public void testWhiteQueenSideCastle() {
        ...
        final MakeTransition t11 = t10.getToBoard().currentPlayer().makeMove(wm1);
    ...
    public void testBlackKingSideCastle() {
        ...
        final MakeTransition t8 = t7.getToBoard().currentPlayer().makeMove(wm1);
        assertTrue(t8.getMoveStatus().isDone());
    ...
    public void testBlackQueenSideCastle() {
        ...
        final MakeTransition t12 = t11.getToBoard().currentPlayer().makeMove(wm1);
