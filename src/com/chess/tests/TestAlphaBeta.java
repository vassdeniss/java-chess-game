...
public class TestAlphaBeta {
    ...
    public void advancedLevelProblem2NakamuraShirov() {
        ...
        builder.setPiece(new King(42, Alliance.WHITE, false, false));
    ...
    public void eloTest1() {
        ...
        builder.setPiece(new Rook(0, Alliance.BLACK));
        builder.setPiece(new Bishop(2, Alliance.BLACK));
        builder.setPiece(new King(6, Alliance.BLACK, false, false));
        builder.setPiece(new Pawn(14, Alliance.BLACK));
        ...
        builder.setMoveDecider(Alliance.BLACK);
        final Board board = builder.build();
        final String fen = FenUtilities.testFENCreate(board);
    ...
    public void eloTest3() {
        ...
        builder.setPiece(new Pawn(20, Alliance.BLACK));
        builder.setPiece(new Pawn(22, Alliance.BLACK));
        builder.setPiece(new King(25, Alliance.BLACK, false, false));
        ...
        builder.setPiece(new King(36, Alliance.WHITE, false, false));
    ...
    public void testCheckmateHorizon() {
        ...
        builder.setPiece(new King(29, Alliance.BLACK, false, false));
        // White Layout
        ...
        builder.setPiece(new Pawn(54, Alliance.WHITE));
        builder.setPiece(new Pawn(55, Alliance.WHITE));
        builder.setPiece(new King(63, Alliance.WHITE, false, false));
        // Set the current player
        builder.setMoveDecider(Alliance.WHITE);
        final Board board = builder.build();
        final MoveStrategy alphaBeta = new StockAlphaBeta(4);
