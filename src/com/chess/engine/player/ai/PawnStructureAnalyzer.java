...
public final class PawnStructureAnalyzer {
    ...
    private static int calculateIsolatedPawnPenalty(final int[] pawnsOnColumnTable) {
        ...
        if (pawnsOnColumnTable[0] > 0 && pawnsOnColumnTable[1] == 0) { numIsolatedPawns += pawnsOnColumnTable[0]; }
        if (pawnsOnColumnTable[7] > 0 && pawnsOnColumnTable[6] == 0) { numIsolatedPawns += pawnsOnColumnTable[7]; }
